...
//
    ...
    private class SubmitQuestion implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(SportsActivity.this, "Your score is=" + score, Toast.LENGTH_LONG).show();
